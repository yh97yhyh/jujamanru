...
extension User {
    static let MOCK_ADMIN: User = .init(id: "admin", nickName: "관리자", isAdmin: true, team: nil, accessToken: "")
    static let MOCK_USER_SSG: User = .init(id: "juman01", nickName: "주만1", isAdmin: false, team: Team.MOCK_TEAMS[2], accessToken: "")
    static let MOCK_USER_LG: User = .init(id: "juman02", nickName: "주만2", isAdmin: false, team: Team.MOCK_TEAMS[0], accessToken: "")
    static let MOCK_USER_KIA: User = .init(id: "juman03", nickName: "주만3", isAdmin: false, team: Team.MOCK_TEAMS[5], accessToken: "")
    static let MOCK_USER_KT: User = .init(id: "juman04", nickName: "주만4", isAdmin: false, team: Team.MOCK_TEAMS[1], accessToken: "")
    static let MOCK_USER_HH: User = .init(id: "juman05", nickName: "주만5", isAdmin: false, team: Team.MOCK_TEAMS[8], accessToken: "")
    static let MOCK_USER_KW: User = .init(id: "juman06", nickName: "주만6", isAdmin: false, team: Team.MOCK_TEAMS[9], accessToken: "")
    static let MOCK_USER_SSG2: User = .init(id: "juman07", nickName: "주만7", isAdmin: false, team: Team.MOCK_TEAMS[2], accessToken: "")
    static let MOCK_USER_KIA2: User = .init(id: "juman08", nickName: "주만8", isAdmin: false, team: Team.MOCK_TEAMS[5], accessToken: "")
    static let MOCK_USER_KIA3: User = .init(id: "juman09", nickName: "주만9", isAdmin: false, team: Team.MOCK_TEAMS[5], accessToken: "")
    static let MOCK_USER_KIA4: User = .init(id: "juman10", nickName: "주만10", isAdmin: false, team: Team.MOCK_TEAMS[5], accessToken: "")
    static let MOCK_USER_KIA5: User = .init(id: "juman11", nickName: "주만11", isAdmin: false, team: Team.MOCK_TEAMS[5], accessToken: "")
